...
function SvgIllustrationFeaturesTab3(props) {
  return (
    <svg width={440} height={380} {...props}>
      <defs>
        <path
          id="illustration-features-tab-3_svg__c"
          d="M0 .048h349.781V296H0z"
        />
        <path
          id="illustration-features-tab-3_svg__e"
          d="M0 .048h157.825v219.844H0z"
        />
        <rect
          id="illustration-features-tab-3_svg__a"
          width={350}
          height={346}
          rx={8}
        />
      ...
      <g fill="none" fillRule="evenodd">
        <mask id="illustration-features-tab-3_svg__b" fill="#fff">
          <use xlinkHref="#illustration-features-tab-3_svg__a" />
        </mask>
        <use
          fill="#E8EAF6"
          fillRule="nonzero"
          xlinkHref="#illustration-features-tab-3_svg__a"
        />
        <g mask="url(#illustration-features-tab-3_svg__b)">
        ...
        <g transform="matrix(-1 0 0 1 440 83)">
          <mask id="illustration-features-tab-3_svg__d" fill="#fff">
            <use xlinkHref="#illustration-features-tab-3_svg__c" />
          </mask>
          <path
            fill="#3A499E"
            ...
            mask="url(#illustration-features-tab-3_svg__d)"
          />
          <path
            fill="#306299"
          ...
          <g transform="translate(2 2)">
            <mask id="illustration-features-tab-3_svg__f" fill="#fff">
              <use xlinkHref="#illustration-features-tab-3_svg__e" />
            </mask>
            <path
              fill="#FFF"
              ...
              mask="url(#illustration-features-tab-3_svg__f)"
              opacity={0.152}
            />
          </g>
          <path
...
export default SvgIllustrationFeaturesTab3;
