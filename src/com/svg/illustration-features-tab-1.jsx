...
function SvgIllustrationFeaturesTab1(props) {
  return (
    <svg width={536} height={346} {...props}>
      <defs>
        <rect
          id="illustration-features-tab-1_svg__a"
          width={536}
          height={346}
          rx={8}
        />
      ...
      <g fill="none" fillRule="evenodd">
        <mask id="illustration-features-tab-1_svg__b" fill="#fff">
          <use xlinkHref="#illustration-features-tab-1_svg__a" />
        </mask>
        <use
          fill="#E8EAF6"
          fillRule="nonzero"
          xlinkHref="#illustration-features-tab-1_svg__a"
        />
        <g mask="url(#illustration-features-tab-1_svg__b)">
...
export default SvgIllustrationFeaturesTab1;
